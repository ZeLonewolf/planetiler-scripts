...
# Requires machine with 512GB ram.  All disk operations happen in ramdisk until final copy to EFS share.
...
planetiler-scripts/aws/01_mount_ramdisk350.sh

cd build

../planetiler-scripts/aws/02_download_planet.sh
../planetiler-scripts/aws/03_render_planet.sh
../planetiler-scripts/aws/04_copy_mbtiles.sh
